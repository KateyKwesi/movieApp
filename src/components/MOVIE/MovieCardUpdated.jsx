...
export const MovieCardUpdated = ({ name, queryKey, queryFn }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto flex flex-col  justify-center overflow-hidden">
      <div className="text-amber-50">
        <h1 className="inline-block text-white text-2xl tracking-widest  font-semibold  m-5 border-b-4 border-slate-600">
          {name}
        </h1>
      </div>
